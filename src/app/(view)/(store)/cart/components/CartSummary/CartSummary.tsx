...
export const CartSummary = ({ cart, count }: CartSummaryProps) => {
  ...
  return (
    <div className="max-w-sm space-y-3">
      <div className="fixed right-0 bottom-0 left-0 flex flex-col items-center gap-2 bg-white p-3 text-sm sm:text-base md:text-lg lg:hidden">
      ...
      <div className="hidden rounded-sm bg-white p-3 lg:block">
        ...
        <button className="cursor-pointer active:black/90 mt-3 w-full rounded-sm bg-black py-3 font-bold text-white hover:bg-black/80 active:bg-black/70">
