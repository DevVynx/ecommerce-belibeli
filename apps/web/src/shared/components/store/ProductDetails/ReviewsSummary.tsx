    ...
    <div className="w-full rounded-lg border">
      ...
      <div className="space-y-3 p-3">
        <div className="flex items-center gap-3 text-sm">
          ...
          <Progress value={80} indicatorProps={{ className: "bg-yellow-400" }} />
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <Progress value={40} indicatorProps={{ className: "bg-yellow-400" }} />
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <Progress value={20} indicatorProps={{ className: "bg-yellow-400" }} />
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <Progress value={10} indicatorProps={{ className: "bg-yellow-400" }} />
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <Progress value={2} indicatorProps={{ className: "bg-yellow-400" }} />
