...
export const SectionError = ({
  ...
  return (
    <motion.div
      layoutId="section-error"
      transition={{ type: "spring", stiffness: 220, damping: 30 }}
      className={cn("mx-auto flex max-w-2xl flex-col items-center gap-8 py-16", className)}
    >
      <motion.div
            ...
            <g transform="translate(-480.785 -126.107)">
              ...
              <g transform="translate(480.785 126.107)">
                ...
                <g transform="translate(93.908 110.78)">
                  <circle cx="103.25" cy="103.25" r="103.25" fill="#0a0a0a" />
                  <path
      ...
      >
        ...
        <p className="text-muted-foreground mx-auto max-w-sm text-sm md:text-base">{description}</p>
      </motion.div>
